...
class Hash:
    ...
    def __init__(self, claves=20, colisiones=4):
        ...
        self.__arregloSecundario=np.zeros(self.__areaPrimaria, dtype=int)
    ...
    def buscar(self, clave):
            ...
            # buscar en el área primaria (fila pos) usando while en vez de for
            j = 0
            ...
            # si no está en primaria, buscar en el área de overflow (también con while)
